...
class BreadIndexSystem extends Module
{
        ...
        function RegisterEvents()
        {
            ...
            $this->manager->RegisterHook($this->name,"Bread.RunSearch","Search");
            $this->manager->RegisterHook($this->name,"Bread.DisplaySearchPage","SearchPage");
            $this->manager->RegisterHook($this->name,"BreadIndexSystem.SearchForm","CreateSearchForm");
        }
