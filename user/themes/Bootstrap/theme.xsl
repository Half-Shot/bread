...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand">
                        <xsl:attribute name="href">
                            <xsl:value-of select="./variable/variable/url" />
                        </xsl:attribute>
    ...
    <xsl:template match="telement[@id='Form']">
        <form>
            ...
            <xsl:attribute name="action">
                <xsl:value-of select="./variable/action" />
            </xsl:attribute>
            <xsl:attribute name="method">
                <xsl:value-of select="./variable/method" />
            </xsl:attribute>
            <xsl:attribute name="formtarget">
                <xsl:value-of select="./variable/formtarget" />
            </xsl:attribute>
            <xsl:attribute name="onsubmit">
                <xsl:value-of select="./variable/onsubmit" />
            </xsl:attribute>
            ...
            <xsl:if test="./pattern != 0">
                ...
                <xsl:if test="./pattern_help != 0">
                    <xsl:attribute name="title">
                        <xsl:value-of select="./pattern_help" />
                    </xsl:attribute>
                </xsl:if>
            </xsl:if>
            <xsl:choose>
            ...
            <xsl:if test="./id != ''">
             ...
             <xsl:if test="./variable/tooltip = 1">
                 ...
                 <xsl:attribute name="data-placement">
                     <xsl:value-of select="./variable/tooltipDirection" />
                 </xsl:attribute>
                 <xsl:attribute name="title">
                     <xsl:value-of select="./variable/tooltipText" />
                 </xsl:attribute>
             </xsl:if>
         </button>
    </xsl:template>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-dialog">
                <xsl:attribute name="style">
                    width:
                    <xsl:value-of select="./variable/width" />
                    %;
                </xsl:attribute>
    ...
    <xsl:template name="Button" match="telement[@id='Button']">
        <button>
            ...
            <xsl:attribute name="onclick">
                <xsl:value-of select="./variable/onclick" />
            </xsl:attribute>
            <xsl:if test="./variable/form != ''">
                <xsl:attribute name="form">
                    <xsl:value-of select="./variable/form" />
                </xsl:attribute>
            </xsl:if>
            <xsl:if test="./variable/hidden = 1">
                <xsl:attribute name="hidden">true</xsl:attribute>
            ...
            <xsl:if test="./variable/thumbnail != ''">
                <a class="pull-left" href="#">
                    <xsl:if test="./variable/thumbnailurl">
                        <xsl:attribute name="href">
                            <xsl:value-of select="./variable/thumbnailurl" />
                        </xsl:attribute>
                    </xsl:if>
                    <img class="media-object" href="#">
                        <xsl:attribute name="src">
                            <xsl:value-of select="./variable/thumbnail" />
                        </xsl:attribute>
                    </img>
                </a>
            </xsl:if>
            <div class="media-body">
                <a>
                    <xsl:if test="./variable/headerurl">
                        <xsl:attribute name="href">
                            <xsl:value-of select="./variable/headerurl" />
                        </xsl:attribute>
                    </xsl:if>
